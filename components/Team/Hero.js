...
const Hero = () => {
  return (
      <div className='flex flex-col items-center mx-auto px-10 lg:px-0 gap-4 w-full overflow-hidden'>
          <h1 className='max-w-3xl text-[#F8F8F8] text-center font-poppins lg:text-[44px] text-3xl font-semibold leading-[150%]'>
          ...
          <div className="relative">
              <Image src={heroTeam2} className='absolute -left-[35%] -top-16'  alt='Hero'/>
