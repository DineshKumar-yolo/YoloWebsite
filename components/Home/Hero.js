    ...
    <div className="bg-gradient-to-b from-black from-40% to-[#650B0B] mix-blend-overlay">
      ...
      <div className="flex flex-col gap-8 items-center py-12 w-1/2 mx-auto font-poppins">
        <div className="flex flex-col gap-4">
          <h1 className="text-[#F8F8F8] text-center text-[44px] font-semibold leading-[150%]">
            Raising Financially Savvy Kids, Introducing Genie
          </h1>
          <p className="text-[#9C9C9C] text-center text-base font-normal leading-[170%] tracking-[-0.165px]">
        ...
        <div className="w-2/3 flex gap-4 items-start">
          <input
            type="number"
            className="py-3 px-3 text-[#3b3b3b] w-7/12 text-base rounded-sm focus:outline-none leading-[150%] lowercase"
