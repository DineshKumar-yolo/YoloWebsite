  ...
  return (
    <div className="overflow-hidden min-w-full">
      <div className="flex flex-col gap-8 items-center xl:py-12 py-16 xl:w-1/2 px-10 mx-auto font-poppins">
        <div className="flex flex-col gap-4">
          ...
          <p className="text-[#9C9C9C] text-center xl:text-base text-xs font-normal leading-[170%] tracking-[-0.165px]">
            Simplified Payment & Seamless access for everyone
          </p>
        </div>
      ...
      <div className="flex flex-wrap flex-row justify-center gap-5 slg:gap-14">
        <div className="md:w-[241px] w-[141px] h-16 xs:h-10 flex gap-2 mt-10 xs:mt-9 slg:mt-20 mlg:mt-[300px] md:py-3 md:px-2 p-2 justify-center items-center rounded-2xl backdrop-blur-sm shrink-0 bg-gradient-to-br from-[#FFFFFF52] via-[#FFFFFF33] to-[#FFE0E033]">
          <Image src={hero_image} alt="hero" width={29} height={29} className="sm:w-[45px] sm:h-[45px]" />
          <p className="text-white font-poppins md:text-xs text-[6px] font-medium leading-normal tracking-[-0.035px]">
            Money Sent <span className="text-[#38C15E]">successfully</span> to Rai
            Mahalaxmi{" "}
          </p>
        </div>
        <div className="flex slg:order-last items-end justify-center gap-6 xs:gap-1 sm:gap-2 md:gap-3 h-3/6 md:px-10 shrink-[10]">
          <Image src={hero_phone_1} alt="Hero" />
          <Image src={hero_phone_2} alt="Hero" />
          <Image src={hero_phone_3} alt="Hero" />
        </div>
        <div className="md:w-[191px] w-[124px] md:h-[91px] h-16 mlg:mt-[100px] md:px-2 md:py-4 p-2 flex flex-col gap-2 justify-center items-start rounded-2xl backdrop-blur-sm shrink-0 bg-gradient-to-br from-[#FFFFFF52] via-[#FFFFFF33] to-[#FFE0E033]">
          <div className="flex justify-between items-center md:gap-2 gap-1">
            <Image src={hero_image_2} height={17} width={17} alt="hero" className="md:w-6 md:h-6" />
