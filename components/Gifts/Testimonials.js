                    ...
                    <div className="flex flex-col items-start gap-3">
                        <div className="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="48" height="38" viewBox="0 0 48 38" fill="none">
                                <path d="M19.223 38H0V19.0571C0 7.7978 6.40767 1.44545 19.223 0V9.47147C13.0072 9.6997 9.82254 12.8949 9.66907 19.0571H19.223V38ZM48 38H28.777V19.0571C28.777 7.7978 35.1847 1.44545 48 0V9.47147C41.7842 9.6997 38.5995 12.8949 38.446 19.0571H48V38Z" fill="url(#paint0_linear_4918_8517)" />
                                <defs>
                                    <linearGradient id="paint0_linear_4918_8517" x1="0" y1="38" x2="48" y2="38" gradientUnits="userSpaceOnUse">
            ...
            <div className="flex flex-col justify-center items-center gap-10 xl:w-[1240px] w-full">
                <div className="flex w-full justify-between items-start">
                    ...
                    <div className="hidden md:flex justify-center items-start gap-[17px]">
                        <button
                            className={`flex h-14 px-3 justify-center items-center xl:text-2xl text-lg border-gradient-bottom ${isLeftButtonDisabled ? "text-[#383838]" : "text-[#585858]"
                                }`}
                            onClick={scrollLeft}
                        ...
                        <button
                            className={`flex h-14 px-3 justify-center items-center xl:text-2xl text-lg border-gradient-bottom ${isRightButtonDisabled ? "text-[#383838]" : "text-[#585858]"
                                }`}
                            onClick={scrollRight}
