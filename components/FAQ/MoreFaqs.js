            ...
            <div className='flex flex-col mlg:flex-row justify-center items-center max-w-[1240px] min-h-[398px] w-full shrink-0 rounded-2xl bg-[#121213] bg-design'>
                <div className='md:mx-28 flex flex-col items-start gap-10 my-14 xl:px-0 px-6'>
                    ...
                    <div className='flex items-start gap-5'>
                        <a href="mailto:web-support@getyolo.in" className='border-gradient-right flex min-w-[168px] px-6 py-4 justify-center items-center gap-3 border bg-[#121213]'>
                ...
                <div className='md:mx-28 flex flex-col items-start gap-10 my-14 xl:px-0 px-6'>
                    ...
                    <form className='flex flex-col gap-6' action="https://formsubmit.co/86cb4e40832f9acfd3be31ff4136d32c" method="POST" >
                        <div className='flex flex-col lg:flex-row gap-6' >
                            <div className='flex flex-col gap-1' >
                                <label htmlFor="Fname" className="font-poppins text-[#6E6E6E] text-[14px] font-medium leading-[150%] tracking-[-0.165px]" >
                                    First name
                                </label>
                                <input type='text' name='Fname' placeholder='Enter First Name' required onChange={(e) => setfName(e.target.value) } className="font-poppins bg-transparent input-border-gradient-right text-[#A0A0A1] text-[16px] font-semibold leading-[150%] tracking-[-0.165px]" />
                            </div>
                            <div className='flex flex-col gap-1' >
                                <label htmlFor="Lname" className="font-poppins text-[#6E6E6E] text-[14px] font-medium leading-[150%] tracking-[-0.165px]" >
                                    Last name
                                </label>
                                <input type='text' name='Lname' placeholder='Enter Last Name' required onChange={(e) => setlName(e.target.value) } className="font-poppins bg-transparent input-border-gradient-right text-[#A0A0A1] text-[16px] font-semibold leading-[150%] tracking-[-0.165px]" />
                            </div>
                        </div>
                        <div className='flex flex-col gap-1' >
                                ...
                                <input type='email' name='email' placeholder='i.e. xyz@gmail.com' required onChange={(e) => setemail(e.target.value) } className="font-poppins bg-transparent input-border-gradient-right text-[#A0A0A1] text-[16px] font-semibold leading-[150%] tracking-[-0.165px]" />
                            </div>
                            <div className='flex flex-col gap-1' >
                                ...
                                <input type='text' name='message' placeholder='Type here' required onChange={(e) => setmessage(e.target.value) } className="font-poppins bg-transparent input-border-gradient-right text-[#A0A0A1] text-[16px] font-semibold leading-[150%] tracking-[-0.165px]" />
                            </div>
